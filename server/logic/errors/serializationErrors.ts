...
const createBodyUserName = () => body('userName')
  .trim()
  .isString()
  .notEmpty()
  .isAlphanumeric()
...
const createBodyPassword = () => body('password')
  .trim()
  .isString()
  .notEmpty()
...
const createBodyText = () => body('text')
  .trim()
  .isString()
  .notEmpty();
...
const createBodyTitle = () => body('title')
  .trim()
  .isString()
  .notEmpty();
...
const bodySourceUrl = body('sourceUrl')
  .trim()
  .isString()
  .notEmpty()
  .optional();
...
export const serializers = {
  auth: {
    ...
    put: [bodyNewEmail, bodyNewUserName, bodyNewPassword, bodyPassword, serializationErrorMiddleware],
