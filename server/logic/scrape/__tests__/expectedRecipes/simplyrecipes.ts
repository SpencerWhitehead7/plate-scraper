const expectedRecipe = `Source: https://www.simplyrecipes.com/recipes/grilled_salmon_with_peach_salsa/
...
Season the salmon: Whisk together paprika, garlic, onion, maple sugar, salt, pepper, and cayenne.
...
Grill the salmon: Brush all sides of the salmon with oil—about a tablespoon total. Brush a bit of oil onto the grill grates as well, ensuring that any fish touching the grates through the grill pan will easily lift away.
